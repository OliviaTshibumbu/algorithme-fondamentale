    ...
    for (int i = 0; i < TAILLE; i++) {
        ...
        for (int j = 1; j < TAILLE; j++) {
            if (tableau[i][j] != 0) {
                ...
                if (tableau[i][position] == 0) {
                    tableau[i][position] = valeur;
                    bouge = 1;
                } else if (tableau[i][position] == valeur) {
                    tableau[i][position] *= 2;
                    *score += tableau[i][position];
                    position++;
                    bouge = 1;
                } else {
                    position++;
                    if (position != j) bouge = 1;
                    tableau[i][position] = valeur;
                }
            }
        }
    ...
    for (int j = 0; j < TAILLE; j++) {
        ...
        for (int i = 1; i < TAILLE; i++) {
            if (tableau[i][j] != 0) {
                ...
                if (tableau[position][j] == 0) {
                    tableau[position][j] = valeur;
                    bouge = 1;
                } else if (tableau[position][j] == valeur) {
                    tableau[position][j] *= 2;
                    *score += tableau[position][j];
                    position++;
                    bouge = 1;
                } else {
                    position++;
                    if (position != i) bouge = 1;
                    tableau[position][j] = valeur;
                }
            }
        }
